...
class GetSinglePosition:
    ...
    def __init__(self, my_logger):
        ...
        self.my_sql = GetSinglePositionMySql(self.my_logger)

    def __log__(self, str_function, str_message, str_level="debug", str_class="GetSinglePosition",
                str_file="user_position/get_single_position"):
    ...
    def start_get_position(self, str_prefix_id):
        return self.my_sql.get_position(str_prefix_id)


class GetSinglePositionMySql:
    my_logger = None
    my_sql = MySQL()
    ...
    def __log__(self, str_function, str_message, str_level="debug", str_class="GetSinglePositionMySql",
                str_file="user_position/get_single_position"):
        # str_level = ['debug', 'error', 'critical']
        if str_level == 'debug':
            self.my_logger.debug("{}.{}.{} | {}".format(str_file, str_class, str_function, str_message))
    ...
    def get_position(self, str_position_id):
        ...
        dict_return['str_id_position'] = ''
        dict_return['str_position_text'] = ''
        dict_return['bool_position_found'] = False
        try:
            ...
            if int_row_count == 1:  # Check That One Row Or More Was Received
                ...
                dict_return['str_id_position'] = list_data[0]
                dict_return['str_position_text'] = list_data[1]
                dict_return['bool_position_found'] = True
