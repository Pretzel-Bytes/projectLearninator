...
class GetUserPositionList:
    ...
    def __init__(self, my_logger):
        ...
        self.my_sql = GetUserPositionListMySQL(self.my_logger)

    def __log__(self, str_function, str_message, str_level="debug", str_class="GetUserPositionList",
                str_file="user_position/get_user_position_list"):
    ...
    def start_get_listing(self):
        return self.my_sql.get_position()


class GetUserPositionListMySQL:
    my_logger = None
    my_sql = MySQL()
    ...
    def __log__(self, str_function, str_message, str_level="debug", str_class="GetUserPositionListMySQL",
                str_file="user_position/get_user_position_list"):
        # str_level = ['debug', 'error', 'critical']
        if str_level == 'debug':
            self.my_logger.debug("{}.{}.{} | {}".format(str_file, str_class, str_function, str_message))
    ...
    def get_position(self):
        ...
        try:
            ...
            dict_result_query = self.my_sql.select_data(table_name='core_authentication_user_position',
                                                        columns=['id_user_position', 'user_position_text'], conditions=[])
            ...
            if int_row_count >= 1:  # Check That One Row Or More Was Received
                ...
                for row in list_data:
                    ...
                    dict_return['arr_position'].append(dict_prefix)
