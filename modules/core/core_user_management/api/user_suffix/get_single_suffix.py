...
class GetSingleSuffix:
    ...
    def __init__(self, my_logger):
        ...
        self.my_sql = GetSingleSuffixMySql(self.my_logger)

    def __log__(self, str_function, str_message, str_level="debug", str_class="GetSingleSuffix",
                str_file="user_suffix/get_single_suffix"):
    ...
    def start_get_suffix(self, str_prefix_id):
        return self.my_sql.get_suffix(str_prefix_id)


class GetSingleSuffixMySql:
    my_logger = None
    my_sql = MySQL()
    ...
    def __log__(self, str_function, str_message, str_level="debug", str_class="GetSingleSuffixMySql",
                str_file="user_suffix/get_single_suffix"):
        # str_level = ['debug', 'error', 'critical']
        if str_level == 'debug':
            self.my_logger.debug("{}.{}.{} | {}".format(str_file, str_class, str_function, str_message))
    ...
    def get_suffix(self, str_suffix_id):
        ...
        dict_return['str_id_suffix'] = ''
        dict_return['str_suffix_text'] = ''
        dict_return['bool_suffix_found'] = False
        try:
            ...
            if int_row_count == 1:  # Check That One Row Or More Was Received
                ...
                dict_return['str_id_suffix'] = list_data[0]
                dict_return['str_suffix_text'] = list_data[1]
                dict_return['bool_suffix_found'] = True
