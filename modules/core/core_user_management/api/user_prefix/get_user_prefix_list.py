...
class GetUserPrefixList:
    ...
    def __init__(self, my_logger):
        ...
        self.my_sql = GetUserPrefixListMySQL(self.my_logger)

    def __log__(self, str_function, str_message, str_level="debug", str_class="GetUserPrefixList",
                str_file="user_prefix/get_user_prefix_list"):
    ...
    def start_get_listing(self):
        return self.my_sql.get_prefix()


class GetUserPrefixListMySQL:
    my_logger = None
    my_sql = MySQL()
    ...
    def __log__(self, str_function, str_message, str_level="debug", str_class="GetUserPrefixListMySQL",
                str_file="user_prefix/get_user_prefix_list"):
        # str_level = ['debug', 'error', 'critical']
        if str_level == 'debug':
            self.my_logger.debug("{}.{}.{} | {}".format(str_file, str_class, str_function, str_message))
    ...
    def get_prefix(self):
        ...
        try:
            ...
            dict_result_query = self.my_sql.select_data(table_name='core_authentication_user_prefix',
                                                        columns=['id_user_prefix', 'user_prefix_text'], conditions=[])
            ...
            if int_row_count >= 1:  # Check That One Row Or More Was Received
                ...
                for row in list_data:
                    ...
                    dict_return['arr_prefix'].append(dict_prefix)
