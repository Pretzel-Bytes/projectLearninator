def(function() {
    let cfg = ({
        ...
        "libs": {
            ...
            "css$pleaseWaitDuoTone": {
                "urls": [
                    "../assets/vendor/fontawesomepro/css/duotone.min.css"
                ]
            },
            "css$pleaseWaitCSS": {
                "urls": [
                    "../assets/vendor/pleasewait/please-wait.css"
                ]
            },
            "pleaseWaitJS": {
                "urls": [
                    "../assets/vendor/pleasewait/please-wait.min.js"
                ]
            }
        }
    });
...
// Load jQuery!
    require(function (pleaseWaitDuoTone, pleaseWaitCSS, pleaseWaitJS, jQuery) {
